...
export const getClientDashboard = async (req, res) => {
  ...
  try {
    const client = await Client.findById(clientId)
      .populate('accountManagerId', 'name email');  // <— add this
    // cases, billables, invoices as you already have…
    // (billables are already populated with caseId & userId in your code)
